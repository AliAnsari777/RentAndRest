...
@WebServlet(name = "deleteBookingController22", urlPatterns = "/deleteBookingController")
...
//        System.out.println("in deleteguest id="+guestid);
        ...
        int bookingid=Integer.parseInt(param);
        ...
        if (result){
            ...
            RequestDispatcher dispatcher = req.getRequestDispatcher("/RentAndRest/getAllBookingController");
